...
**Config:** `LRU` · `16 DTLB entries` · `64 physical frames (256KB)` · `4KB direct-mapped L1D (1cy hit)` · `No L2` · `PIPT`
...
### Trace Replay Results — Expanded Hardware Configuration (Experimentation)

**Config:** `LRU` · `16 DTLB` · `64 physical frames (256KB)` · `4KB Direct-Mapped L1D` · `8KB 4-way L2` · `PIPT`
